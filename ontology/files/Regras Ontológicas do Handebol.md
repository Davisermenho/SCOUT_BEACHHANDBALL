...
Gol Criativo possui_status VALIDADO.
Gol Espetacular possui_status VALIDADO.
Conduta Antidesportiva possui_status VALIDADO.

Conduta Gravemente Antidesportiva possui_status VALIDADO.
Ação Particularmente Perigosa possui_status VALIDADO.
Goleiro vs. Especialista possui_status VALIDADO.
Regra da Vantagem possui_status VALIDADO.
Perigo Climático possui_status VALIDADO.
Desperdício de Tempo possui_status CATEGORIA_CONTROLADA_COM_AVALIAÇÃO_HUMANA.
Chance Clara de Gol possui_status VALIDADO.
