...
## DH-ESP-001 — Especialista

```yaml
decision_id: DH-ESP-001
data: 2026-06-19
autoridade: Davi Sermenho
tipo_de_autoridade: especialista_do_dominio_e_autor_do_modelo
status: REGISTRADA_LITERALMENTE
conceitos_afetados:
  - Especialista
  - Goleiro
  - Papel_Tático
  ...
  - Valor_Do_Gol
pergunta_contextual: >
  Esclarecer a diferença entre goleiro e especialista e a consequência
  dessa diferença para a pontuação e para a modelagem ontológica.
resposta_literal: >
  Em relaçao ao especialista você ainda erra. Goeleiro sempre será goleiro,
  especialista não. o goleiro sai da aerea ele continua sendo goleiro. se um
  time sofre uma falta de ataque, o goleiro sai da aera para cobrar a falta,
  ele nao vira especialista. Ele continua sendo goleiro. Ja o epecialista,
  sempre será esepcialista. Se ele entra na area ele é e especialista. Se ele
  nao consegue sair e vai pro gol, ele é um epecialista atuando como goleiro.
  O papel de especialista é uma condição não por causa da regra, mas sim pelo
  desenvolvimrnto tático e não existe e nunca existirá, em nenhnum jogo, um gol
  do especialista que vá valer 1 ponto.
decisoes_extraidas:
  - Goleiro permanece goleiro independentemente de sair da área.
  - Goleiro que cobra falta fora da área continua sendo goleiro.
  - Goleiro não se transforma em especialista por atuar no ataque ou cobrar uma falta.
  - Especialista permanece especialista independentemente de entrar na área.
  - Especialista que atua momentaneamente no gol continua sendo especialista.
  - Especialista atuando como goleiro não se transforma em goleiro.
  - O papel de especialista é uma condição tática, derivada do desenvolvimento tático do jogo.
  - O papel de especialista não é criado pela regra oficial.
  - Todo gol marcado por especialista vale 2 pontos.
  - Não existe gol de especialista valendo 1 ponto no domínio do especialista humano.
inferencias_proibidas:
  - Não inferir que posição espacial altera o papel tático.
  - Não inferir que entrar na área transforma especialista em goleiro.
  - Não inferir que sair da área transforma goleiro em especialista.
  - Não inferir que especialista pode marcar gol de 1 ponto.
  - Não substituir o conceito de Especialista por Goleiro.
  - Não modelar Especialista apenas como papel regulamentar oficial.
separacoes_obrigatorias:
  - Papel_Tático é diferente de Função_Situacional.
  - Papel_Tático é diferente de Posição_Espacial.
  - Especialista é diferente de Goleiro.
  - Especialista_Atuando_Como_Goleiro é diferente de Goleiro.
  - Goleiro_Atuando_No_Ataque é diferente de Especialista.
teste_de_competencia_obrigatorio:
  entrada:
    papel_tatico: Especialista
    posicao_espacial: Area_De_Gol
    funcao_situacional: Defender_O_Gol
    evento: Gol
  esperado:
    papel_tatico_final: Especialista
    valor_do_gol: 2
    inferencia_proibida:
      - Reclassificar como Goleiro
      - Atribuir 1 ponto
```

---

## Regras de uso desta decisão

Esta decisão não deve ser reinterpretada por conhecimento geral da IA.

Esta decisão só pode ser alterada por nova decisão humana literal do especialista.

Qualquer conflito entre esta decisão e uma formalização futura deve bloquear a formalização até revisão humana.

---

## Próximas decisões humanas a registrar

1. Goleiro versus Especialista em relação ao regulamento e ao scout.
2. Gol de Especialista.
3. Gol Criativo.
4. Gol Espetacular.
5. Conduta Antidesportiva.
6. Conduta Gravemente Antidesportiva.
7. Ação Particularmente Perigosa.
8. Chance Clara de Gol.
9. Vantagem.
10. Perigo Climático.
